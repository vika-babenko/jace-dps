...
var HttpImplError = function(message) {
    this.message = message;
    this.name = "Command 'http' implementation error";
}
HttpImplError.prototype = Object.create(Error.prototype);
HttpImplError.prototype.constructor = HttpImplError;
