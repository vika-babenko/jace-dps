...
// console.log(gh(`https://github.com/javascript-tutorial/ru.javascript.info/HEAD/1-js/04-object-basics/02-garbage-collection/memory-user-john.svg`))
...
function buildImageUrl (repository, url) {
  ...
  return prefix + path.join(repository.user, repository.repo, DEFAULT_REF, repository.path, url.href)
}
...
module.exports = function (md, opts) {
  ...
  var repo = gh(opts.git)
  
  repo.path = opts.git.replace(repo.https_url,"")
