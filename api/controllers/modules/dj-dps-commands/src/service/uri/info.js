...
module.exports = {
    name: "service.uri.info",

    synonims: {
        "service.uri.info": "service.uri.info"
    },
                                                ...
                                                .then( address => {
                                                    uriUtils.aboutIp(address)
                                                        .then( data => {
                                                            ...
                                                            command.settings.data[index][selector] = JSON.parse(JSON.stringify(data))
                                                            resolve(true)        
                                                        })
                                                        .catch( e => {
