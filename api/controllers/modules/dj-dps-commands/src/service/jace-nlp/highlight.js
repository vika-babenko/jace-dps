...
let request = {
  ...
  url: "https://jace-text.herokuapp.com/ner/highlight",
...
module.exports = {
    name: "service.nlp.ner.highlight",

    synonims: {
        "service.nlp.ner.highlight": "service.nlp.ner.highlight"
    },
    ...
    defaultProperty: {
        "service.nlp.ner.highlight" : "text"
    },

    execute: function(command, state) {

        let text = command.settings.text || state.head.data
        let htmlTemplate = command.settings.template
        return new Promise((resolve, reject) => {

            request.data = {text, htmlTemplate}
            axios(request)
                .then(response => {
