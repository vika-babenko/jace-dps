...
module.exports = {
    ...
    execute: function(command, state, config) {
       ...
       if(!command.settings.mapper)
            throw new StatImplError("Standartization mapper not defined")
        ...
        command.settings.named = command.settings.named || "std"

        try {

            let res = STAT.standardize(
                s_util.array2floats(
